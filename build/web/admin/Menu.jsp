            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="AllMessage.jsp">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div style="display:flex">
                                                        <p class="card-title">ALL Menu</p>
                                                        <button type="button" class="btn btn-primary" style="margin-left: 70%"><a href="addnewdish.jsp" style="text-decoration: none;color: white;">Add New Dish</a></button>
                                                    </div>
                                                    <div class="table-responsive">
                                                        <table id="recent-purchases-listing" class="table">
                                                            ...
                                                            %>
                                                            <tr>
                                                                <td><%=rs.getString("dish")%></td>
                                                                <td><%=rs.getString("descripition")%></td>
                                                                <td><%=rs.getString("price")%></td>
                                                               <td><a href='EditDish.jsp?u=<%=rs.getString("id")%>'>
                                                                        <button type="button" class="btn btn-warning">Edit</button>
                                                                    </a>
                                                                </td> 
                                                                <td><a href='DeleteDish.jsp?delete=<%=rs.getString("id")%>'>
                                                                        <button type="button" class="btn btn-inverse-danger btn-fw">Delete</button>
                                                                    </a>
                                                                </td>
                                                            </tr>
