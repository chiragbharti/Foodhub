                                ...
                                <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 stretch-card">
                                            <div class="card">
                                                <div class="card-body">
                                                    <p class="card-title">ADD New Dish</p>
                                                    <div class="table-responsive">
                                                        <div class="col-12 grid-margin stretch-card">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    
                                                                    <form class="forms-sample" action="addnewdishdatabase.jsp" method="post">
                                                                        <div class="form-group">
                                                                            <label for="exampleInputName1">Dish</label>
                                                                            <input type="text" name="dish" class="form-control" id="exampleInputName1" placeholder="Dish">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail3">Description</label>
                                                                            <input type="text" name="descripition" class="form-control" id="exampleInputEmail3" placeholder="descripition">
                                                                        </div> 
                                                                        <div class="form-group">
